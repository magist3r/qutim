...
cmake $CODEDIR/qutim-0.2.80 \
-DANDROID_NDK_TOOLCHAIN_ROOT="$CODEDIR/android-toolchain2/" \
...
-DQT_QTOPENGL_INCLUDE_DIR=$CODEDIR/qt-android/include/QtOpenGL \
...
-DQT_QTOPENGL_LIBRARY=$CODEDIR/qt-android/lib/libQtOpenGL.so \
-DQT_QTOPENGL_LIBRARY_DEBUG=$CODEDIR/qt-android/lib/libQtOpenGL.so \
-DQT_QTOPENGL_LIBRARY_RELEASE=$CODEDIR/qt-android/lib/libQtOpenGL.so \
